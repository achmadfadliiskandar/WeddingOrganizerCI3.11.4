            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                <div class="brand-logo">
                  <img src="<?= base_url(uri: 'assets/skydash/skydash-v.01/')?>images/logo.svg" alt="logo">
                </div>
                <h4>Hello! let's get started</h4>
                <h6 class="font-weight-light"><strong>Sign in to continue.</strong></h6>
                <form class="pt-3" action="<?php echo base_url('admin/authenticate'); ?>" method="post">
                  ...
                  <div class="mt-3 d-grid gap-2">
                    ...
                    <!-- <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="<?= base_url(uri: 'assets/skydash/skydash-v.01/')?>index.html">SIGN IN</a> -->
                  </div>
